...
<table cellpadding="5" cellspacing="0" border="0" width="100%">
      ...
      <td>
        <input class="text_area" type="hidden" name="first_name" id="first_name" size="32" maxlength="40" value="<?php echo $this->object->first_name; ?>" />
    ...
    <tr>
      ...
      <td>
        <input class="text_area" type="hidden" name="last_name" id="last_name" size="32" maxlength="40" value="<?php echo $this->object->last_name; ?>" />
    ...
    <tr>
      ...
      <td>
        <input class="text_area" type="text" name="description" id="description" size="30" maxlength="50" value="<?php echo $this->object->description; ?>" />
<!--        <?php echo $this->editor->display('description', $this->object->description, '60%', '300', '70', '15'); ?> -->
      </td>
    </tr>
</table>
