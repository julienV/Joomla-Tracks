 ...
 * @since 0.1
 */
class TracksFrontViewexternalresults extends JView
{
...
$option = JRequest::getCmd('option');
    ...
    $breadcrumbs->addItem( $project->name. ' ' . JText::_('COM_TRACKS_Rankings' ), 'index.php?option=com_tracks&view=externalresults&p=' . $project_id );
    ...
    $season_name = JRequest::getVar( 'pr', 0, '', 'int' );
    $this->assignRef( 'test',	$season_name );
