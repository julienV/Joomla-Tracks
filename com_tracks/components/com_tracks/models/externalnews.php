 ...
 * @since 0.1
 */
class TracksFrontModelexternalnews extends baseModel
{ 
	/**
	 * individual id
	 *
  ...
  function setId($id)
  {
	...
	function getData()
	{
        ...
        if ($this->_data->picture != '') {
          ...
          $this->_data->picture = JHTML::image(JURI::base().'tnnophoto.jpg', $this->_data->first_name. ' ' . $this->_data->last_name, $attribs);
        }
        ...
        if ($this->_data->picture_small != '') {
          ...
          $this->_data->picture_small = JHTML::image(JURI::base().'tnnophoto.jpg', $this->_data->first_name. ' ' . $this->_data->last_name, $attribs);
        }
  ...
  function store($data, $picture, $picture_small)
  {
    ...
    if ( !empty($picture['name']) )  {
      ...
      $base_Dir   = JPATH_SITE.DS.'individuals'.DS;
    ...
    if ( !empty($picture_small['name']) )  {
      ...
      $base_Dir   = JPATH_SITE.DS.'individuals'.DS.'small'.DS;
