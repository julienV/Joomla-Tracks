...
<div class="tracksmenu-box">
    ...
    <div class="m">
		<ul class="tracksmenu">
		  <?php /*
			<li><?php
			$link   = JRoute::_( 'index.php?option=com_tracks' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Cpanel' ); ?>"> <?php echo JText::_( 'Cpanel' ); ?></a>
			</li>
      */?>
			<li>
			<?php
			$link   = JRoute::_( 'index.php?option=com_tracks&view=projects' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Projects' ); ?>"> <?php echo JText::_( 'Projects' ); ?></a>
			</li>
			<li><?php
			$link   = JRoute::_( 'index.php?option=com_tracks&view=competitions' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Competitions' ); ?>"> <?php echo JText::_( 'Competitions' ); ?></a>
			</li>
			<li><?php
			$link   = JRoute::_( 'index.php?option=com_tracks&view=seasons' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Seasons' ); ?>"> <?php echo JText::_( 'Seasons' ); ?></a>
			</li>
			<li><?php
			$link   = JRoute::_( 'index.php?option=com_tracks&view=teams' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Teams' ); ?>"> <?php echo JText::_( 'Teams' ); ?></a>
			</li>
			<li><?php
			$link   = JRoute::_( 'index.php?option=com_tracks&view=individuals' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Individuals' ); ?>"> <?php echo JText::_( 'Individuals' ); ?></a>
			</li>
			<li><?php
			$link   = JRoute::_( 'index.php?option=com_tracks&view=rounds' );
			?> <a href="<?php echo $link; ?>"
				title="<?php echo JText::_( 'Rounds' ); ?>"> <?php echo JText::_( 'Rounds' ); ?></a>
			</li>
      <li><?php
      $link   = JRoute::_( 'index.php?option=com_tracks&view=subroundtypes' );
      ?> <a href="<?php echo $link; ?>"
        title="<?php echo JText::_( 'Sub rounds types' ); ?>"> <?php echo JText::_( 'Sub rounds types' ); ?></a>
      </li>
      <li><?php
      $link   = JRoute::_( 'index.php?option=com_tracks&view=about' );
      ?> <a href="<?php echo $link; ?>"
