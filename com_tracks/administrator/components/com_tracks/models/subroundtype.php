...
/**
 * Joomla Tracks Component ub round type Model
 *
 * @author Julien Vonthron <julien.vonthron@gmail.com>
 * @package   Tracks
 * @since 0.2
 */
class TracksModelSubroundType extends TracksModelItem
{  
	/**
	...
	* @since	1.6
	*/
	public function getTable($type = 'subroundtype', $prefix = 'table', $config = array())
	{
