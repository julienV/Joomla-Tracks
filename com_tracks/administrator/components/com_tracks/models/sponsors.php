 ...
 * @since		1.7
 */
class TracksModelSponsors extends JModelList
{
	 ...
	 * @since	1.6
	 */
	protected function populateState($ordering = 'a.name', $direction = null)
	{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__tracks_sponsors').' AS a');
