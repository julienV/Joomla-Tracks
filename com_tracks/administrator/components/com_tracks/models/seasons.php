<?php
/**
* @version    $Id: seasons.php 15 2008-02-06 00:37:43Z julienv $ 
 ...
 * @since 0.1
 */
class TracksModelSeasons extends TracksModelList
{
	...
	function _buildContentOrderBy()
	{
		...
		$filter_order_Dir	= $mainframe->getUserStateFromRequest( $option.'.viewseasons.filter_order_Dir',	'filter_order_Dir',	'',				'word' );
	...
	function _buildContentWhere()
	{
		...
		$search				= $mainframe->getUserStateFromRequest( $option.'.viewseasons.search',			'search',			'',				'string' );
