 ...
 * @since    2.0
 */
class FOFFormFieldTracksprojecttitle extends FOFFormFieldText implements FOFFormField
{
	/**
	...
	public function getRepeatable()
	{
		...
		$link = $this->element['select_url'];
		$link = $this->parseFieldTags($link);

		// Get the regular display
		$html = parent::getRepeatable();

		$html .= ' | ' . JHtml::link($link,  JText::_('COM_TRACKS_SELECT'));
