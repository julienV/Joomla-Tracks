 ...
 * @since    2.0
 */
class FOFFormFieldJlvyesno extends JFormFieldList implements FOFFormField
{
	protected $static;
	...
	public function getRepeatable()
	{
		...
		$img = $this->value ? 'yes.png' : 'no.png';
		$alt = $this->value ? JText::_('JYES') : JText::_('JNO');

		$attribs = array('title' => $alt);

		$html = JHtml::image('com_tracks/' . $img, $alt, $attribs, true);
