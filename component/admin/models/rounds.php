...
/**
 * Tracks Component rounds Model
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksModelRounds extends TrackslibModelList
{
	/**
	 ...
	 * @var  string
	 */
	protected $filterFormName = 'filter_rounds';
	 ...
	 * @var  string
	 */
	protected $limitField = 'rounds_limit';
	...
	protected function getListQuery()
	{
		...
		$query->from($db->qn('#__tracks_rounds', 'obj'));
