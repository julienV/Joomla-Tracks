...
/**
 * Tracks Component seasons Model
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksModelSeasons extends TrackslibModelList
{
	/**
	 ...
	 * @var  string
	 */
	protected $filterFormName = 'filter_seasons';
	 ...
	 * @var  string
	 */
	protected $limitField = 'seasons_limit';
	...
	protected function getListQuery()
	{
		...
		$query->from($db->qn('#__tracks_seasons', 'obj'));
