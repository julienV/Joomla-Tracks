...
/**
 * HTML View class for Tracks competitions
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksViewCompetitions extends TrackslibViewAdmin
{
	/**
	...
	{
		return JText::_('COM_TRACKS_COMPETITIONS');
	}
	...
	public function getToolbar()
	{
		...
		{
			$new = RToolbarBuilder::createNewButton('competition.add');
			$firstGroup->addButton($new);
		}

		if ($user->authorise('core.edit', 'com_tracks'))
		{
			$edit = RToolbarBuilder::createEditButton('competition.edit');
			$secondGroup->addButton($edit);
		}

		if ($user->authorise('core.delete', 'com_tracks'))
		{
			$delete = RToolbarBuilder::createDeleteButton('competitions.delete');
