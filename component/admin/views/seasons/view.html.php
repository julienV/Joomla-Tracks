...
/**
 * HTML View class for Tracks seasons
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksViewSeasons extends TrackslibViewAdmin
{
	/**
	...
	{
		return JText::_('COM_TRACKS_SEASONS');
	}
	...
	public function getToolbar()
	{
		...
		{
			$new = RToolbarBuilder::createNewButton('season.add');
			$firstGroup->addButton($new);
		}

		if ($user->authorise('core.edit', 'com_tracks'))
		{
			$edit = RToolbarBuilder::createEditButton('season.edit');
			$secondGroup->addButton($edit);
		}

		if ($user->authorise('core.delete', 'com_tracks'))
		{
			$delete = RToolbarBuilder::createDeleteButton('seasons.delete');
