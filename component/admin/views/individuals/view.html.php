...
/**
 * HTML View class for Tracks individuals
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksViewIndividuals extends TrackslibViewAdmin
{
	/**
	...
	{
		return JText::_('COM_TRACKS_INDIVIDUALS');
	}
	...
	public function getToolbar()
	{
		...
		{
			$new = RToolbarBuilder::createNewButton('individual.add');
			$firstGroup->addButton($new);
		}

		if ($user->authorise('core.edit', 'com_tracks'))
		{
			$edit = RToolbarBuilder::createEditButton('individual.edit');
			$secondGroup->addButton($edit);
		}

		if ($user->authorise('core.delete', 'com_tracks'))
		{
			$delete = RToolbarBuilder::createDeleteButton('individuals.delete');
