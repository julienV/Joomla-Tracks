...
$saveOrderUrl = 'index.php?option=com_tracks&task=projectrounds.saveOrderAjax&tmpl=component';
...
<script type="text/javascript">
	...
	submitbutton = function (pressbutton)
	{
		...
		if (pressbutton == 'projectrounds.delete')
		{
			var r = confirm('<?php echo JText::_("COM_TRACKS_PROJECTROUND_DELETE_COMFIRM")?>');
				...
				<tr>
					...
					<td>
						<?php if ($this->canEditState) : ?>
							<?php echo JHtml::_('rgrid.published', $row->published, $i, 'projectrounds.', true, 'cb'); ?>
						<?php else : ?>
					...
					<?php if ($this->canEdit) : ?>
						<td>
							<?php if ($row->checked_out) : ?>
								...
								echo JHtml::_('rgrid.checkedout', $i, $editor->name, $row->checked_out_time, 'projectrounds.', $canCheckin);
								?>
							<?php endif; ?>
						</td>
					<?php endif; ?>
