...
/**
 * HTML View class for Tracks rounds
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksViewRounds extends TrackslibViewAdmin
{
	/**
	...
	{
		return JText::_('COM_TRACKS_ROUNDS');
	}
	...
	public function getToolbar()
	{
		...
		{
			$new = RToolbarBuilder::createNewButton('round.add');
			$firstGroup->addButton($new);
		}

		if ($user->authorise('core.edit', 'com_tracks'))
		{
			$edit = RToolbarBuilder::createEditButton('round.edit');
			$secondGroup->addButton($edit);
		}

		if ($user->authorise('core.delete', 'com_tracks'))
		{
			$delete = RToolbarBuilder::createDeleteButton('rounds.delete');
