...
/**
 * HTML View class for Tracks teams
 *
 * @package     Tracks
 * @subpackage  Admin
 * @since       3.0
 */
class TracksViewTeams extends TrackslibViewAdmin
{
	/**
	...
	{
		return JText::_('COM_TRACKS_TEAMS');
	}
	...
	public function getToolbar()
	{
		...
		{
			$new = RToolbarBuilder::createNewButton('team.add');
			$firstGroup->addButton($new);
		}

		if ($user->authorise('core.edit', 'com_tracks'))
		{
			$edit = RToolbarBuilder::createEditButton('team.edit');
			$secondGroup->addButton($edit);
		}

		if ($user->authorise('core.delete', 'com_tracks'))
		{
			$delete = RToolbarBuilder::createDeleteButton('teams.delete');
